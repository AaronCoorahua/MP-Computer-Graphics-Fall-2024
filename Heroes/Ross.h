...
public:
    ...
    Ross( GLuint shaderProgramHandle, GLint mvpMtxUniformLocation, GLint normalMtxUniformLocation, GLint materialColorUniformLocation );
    ...
    void drawRoss( glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx, GLfloat time );

    /// \desc simulates the plane flying forward by rotating the propeller clockwise
    void moveForward(GLfloat WORLD_SIZE);
    /// \desc simulates the plane flying backward by rotating the propeller counter-clockwise
    void moveBackward(GLfloat WORLD_SIZE);

    glm::vec3 _getPosition() const;
...
private:
    ...
    GLfloat rotateAngle = 0.1f;
    glm::vec3 position;
    glm::vec3 heading = glm::vec3( 1.0f, 0.0f, 0.0f );
    ...
    /// \param viewMtx camera view matrix to apply to plane
    /// \param projMtx camera projection matrix to apply to plane
    void _drawWHead(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const;
    ...
    void _drawStaff(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx , GLfloat time) const;
